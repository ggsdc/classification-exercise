...
results['f25u'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
...
results['f50u'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['f75u'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['w25u'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['w50u'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['w75u'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['f25m'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['f50m'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['f75m'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['w25m'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['w50m'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
...
results['w75m'] = model_evaluation(X_train_reduced, y_train, X_test_reduced, y_test,
                                   X_reduced, y, folds, n_attributes, skip=False)
